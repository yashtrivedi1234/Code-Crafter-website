...
@media (max-width: 640px) { 
  ...
  /* OPTIMIZED: Much smaller font and better spacing for mobile */
  .sm-scope .sm-panel-item { 
      font-size: 1.8rem; /* Reduced from 2.5rem for better fit */
      padding-right: 1.5em; 
      letter-spacing: -0.5px; 
  }
  
  /* OPTIMIZED: Numbering aligned with the smaller font */
  .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { 
      right: 0; 
      top: 0.1em; /* Aligns number perfectly with the text baseline */
      font-size: 12px; 
  }
  
  /* OPTIMIZED: Tighter padding so it looks clean on small screens */
  .sm-scope .staggered-menu-panel { padding: 6em 1.5em 2em 1.5em; }
  .sm-scope .staggered-menu-header { padding: 1.2em; }
}
      `}</style>
    </div>
  );
