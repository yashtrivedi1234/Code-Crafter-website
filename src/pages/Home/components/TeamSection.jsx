...
const TeamSection = () => {
  ...
  return (
    <section className="relative min-h-screen bg-white text-gray-900 flex items-center justify-center p-6 md:p-12 overflow-hidden selection:bg-cyan-100 selection:text-[#175E75]">
      ...
      >
        ...
        <div className="space-y-10 pl-0 lg:pl-10">
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <span className={`${brandTealText} text-sm font-bold uppercase tracking-[0.3em] block`}>
              Our DNA
            </span>
            <h2 className="text-5xl lg:text-7xl font-black tracking-tighter text-gray-950 leading-[0.95]">
              Meet our <br /> <span className={brandTealText}>creative</span> team
            </h2>
          ...
          >
            As a leading <span className={`${brandTealText} font-bold`}>web design</span> and development agency, 
            we bring together innovation and technical excellence to craft custom solutions 
            that drive business success worldwide.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="pt-4">
            <a href="#team" className="inline-block group">
              <div className="relative w-44 h-44 flex items-center justify-center rounded-full border-2 border-gray-200 bg-white hover:border-[#175E75] transition-colors duration-500 overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-[#175E75]/10">
                ...
                <div className={`absolute inset-0 ${brandTealBg} translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out rounded-full`} />
                
                <div className="relative z-10 flex flex-col items-center gap-2 group-hover:text-white transition-colors duration-300">
                  <span className="font-bold text-lg tracking-wide">Join us</span>
      ...
      >
        <button className={`${brandTealBg} hover:opacity-90 text-white py-8 px-4 rounded-l-2xl font-bold tracking-widest shadow-2xl hover:-translate-x-2 transition-all duration-300 group flex items-center justify-center border-y border-l border-white/20`}>
