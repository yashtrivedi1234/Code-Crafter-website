      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative flex justify-center items-center">
          <img 
            ...
            className="w-full max-w-md lg:max-w-full drop-shadow-2xl rounded-2xl object-cover h-[550px] z-10" 
          />
          
          {/* Decorative Background Blobs - Synced with Teal Theme */}
        ...
        <div className="flex flex-col gap-8 z-10">
          ...
          <form 
            ...
            className="space-y-5 bg-white p-8 md:p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100"
          >
            ...
            <div>
              <textarea 
                ...
                className={`w-full px-5 py-4 rounded-xl border border-gray-200 bg-gray-50 text-gray-800 placeholder-gray-400 focus:ring-2 ${brandFocusRing} focus:border-transparent focus:bg-white outline-none transition-all resize-none`} 
                required
              ></textarea>
            </div>
            ...
            <button 
              type="submit" 
              className={`w-full inline-flex items-center justify-center gap-3 px-8 py-5 ${brandBg} hover:opacity-90 text-white font-bold text-lg rounded-xl transition-all shadow-xl ${brandShadow} hover:translate-y-[-2px]`}
            >
              Talk to our experts
