...
import { Globe, Smartphone, Palette, ShoppingCart, Cloud, BarChart3, ArrowRight } from 'lucide-react';
    ...
    <section className="py-8 px-8 md:px-16 bg-gradient-to-b from-white via-slate-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-10">
          <span className="inline-block px-4 py-2 rounded-full bg-[#175E75]/10 text-[#175E75] text-sm font-bold mb-4 uppercase tracking-wider">Services</span>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-5">
                  <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${service.color} text-white flex items-center justify-center shadow-lg transition-all duration-300 ${ 
                    isHovered ? 'scale-125 rotate-12 shadow-xl' : 'group-hover:scale-110'
                  }`}>
                    <IconComponent size={32} className={`transition-transform duration-300 ${ 
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${ 
                    ...
                    <ArrowRight size={20} className={`transition-all duration-300 ${ 
                      isHovered ? 'text-white scale-125 translate-x-1' : 'text-[#175E75]'
                    }`} />
                  </div>
                </div>
